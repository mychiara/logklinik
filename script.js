    ...
    .map((m) => {
      ...
      const otherGroup =
        m.kelompok && m.kelompok !== "-" && m.kelompok !== kelompokId
          ? `<span class="badge bg-warning" style="font-size:0.75em; margin-left:6px; text-transform:uppercase;">DI ${otherGroupName}</span>`
          : "";
      return `
